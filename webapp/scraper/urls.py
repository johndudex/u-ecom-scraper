...
urlpatterns = [
    ...
    path("probe-tester/cached-method/", views.probe_tester_cached_method, name="probe_tester_cached_method"),
    path("probe-tester/clear-cache/", views.probe_tester_clear_cache, name="probe_tester_clear_cache"),
    path("probe-tester/update-cache/", views.probe_tester_update_cache, name="probe_tester_update_cache"),

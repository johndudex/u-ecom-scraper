...
urlpatterns = [
    ...
    path(
        "sites/<int:site_id>/scraper-code/",
        views.site_scraper_code,
    ...
    path(
        "sites/<int:site_id>/output/<str:filename>/download/",
        views.site_output_download,
        name="site_output_download",
    ),
    ...
    path("probe-tester/", views.probe_tester, name="probe_tester"),
    path(
        "probe-tester/cached-method/",
        views.probe_tester_cached_method,
        name="probe_tester_cached_method",
    ),
    path(
        "probe-tester/clear-cache/",
        views.probe_tester_clear_cache,
        name="probe_tester_clear_cache",
    ),
    path(
        "probe-tester/update-cache/",
        views.probe_tester_update_cache,
        name="probe_tester_update_cache",
    ),
    ...
    path(
        "jobs/<int:job_id>/pending-approvals/",
        views.pending_approvals_fragment,
        name="pending_approvals_fragment",
    ),
    ...
    path(
        "jobs/<int:job_id>/approve/<int:approval_id>/",
        views.approval_inline,
    ...
    path(
        "agent-playground/list/",
        views.agent_playground_list,
        name="agent_playground_list",
    ),
    path(
        "agent-playground/<int:playground_id>/",
